    ...
    <section id="features" className="bg-muted/30 py-20 md:py-28">
      ...
      >
        ...
        <div className="mt-16 grid gap-4 md:grid-cols-12">
          {/* LEFT SIDE (Keyword Analysis + 50/50 Bottom Row) */}
          <div className="flex flex-col gap-4 md:col-span-7">
            {/* Card 1 — Keyword Research */}
            <motion.div
              variants={fadeUpVariants}
              className="group flex flex-col overflow-hidden border-2 border-secondary bg-background transition-all duration-500 hover:shadow-[0_8px_40px_hsl(146_75%_51%/0.12)]"
            >
              <div className="p-6 pb-4 flex-shrink-0">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <h3 className="font-display text-lg font-bold text-secondary">Keyword Analysis</h3>
                  </div>
                </div>
                ...
                <button className="group/btn mt-3 inline-flex items-center gap-1.5 text-sm font-semibold text-primary transition-colors hover:text-primary/80">
                  Get Started{" "}
                  <ArrowRight className="h-3.5 w-3.5 transition-transform group-hover/btn:translate-x-0.5" />
                </button>
              </div>
              <div className="px-6 mt-auto">
                <div className="relative overflow-hidden border border-b-0 border-border rounded-t-lg shadow-sm">
                  <img
            ...
            {/* Bottom Row inside Left Side (Perfectly Equal Widths) */}
            <div className="grid gap-4 sm:grid-cols-2 flex-1">
              ...
              >
                <div className="p-6 pb-4 flex-shrink-0">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Automated weekly tracking across all major LLMs with real-time alerts on visibility changes and
          ...
          {/* RIGHT SIDE (Deep Research - Tall Card) */}
          <div className="md:col-span-5">
            <motion.div
              variants={fadeUpVariants}
              className="group flex flex-col h-full overflow-hidden border-2 border-secondary bg-background transition-all duration-500 hover:shadow-[0_8px_40px_hsl(146_75%_51%/0.12)]"
            >
              <div className="p-6 pb-4 flex-shrink-0">
                <div className="flex items-start gap-3 mb-3">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center bg-primary/10">
                  ...
                  <div>
                    ...
                    <h3 className="font-display text-lg font-bold text-secondary">Deep Research</h3>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground leading-relaxed">
